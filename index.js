import{a as w,i as k,S as N,N as z,P as R,b as W}from"./assets/vendor-7WN_uEAT.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}})();const $=document.querySelector(".loader-more"),x=document.querySelector(".loader-more-container"),_=document.querySelector(".furniture-list"),A=document.querySelector(".load-more-btn");let a=1,l=null;const L=8;window.allFurnitures=window.allFurnitures||[];async function U(){try{const t=(await w("https://furniture-store.b.goit.study/api/categories")).data;t.unshift({_id:"0",name:"Всі товари"}),document.querySelectorAll(".category-card").forEach((o,r)=>{const i=t[r];if(!i)return;o.dataset.id=i._id;const c=o.querySelector(".category-title");c&&(c.textContent=i.name)})}catch{k.show({message:"Sorry, something went wrong. Please try again!",position:"topRight",messageColor:"#fff",titleColor:"#fff",color:"#ef4040",iconUrl:"../images/our-furniture/bi_x-octagon-2.svg",maxWidth:432})}}async function u(e=1,t){try{J(),S();let s=`https://furniture-store.b.goit.study/api/furnitures?limit=${L}&page=${e}`;t&&t!=="0"&&(s+=`&category=${t}`);const r=(await w(s)).data;X(r),l===null&&(l=Math.ceil(r.totalItems/L)),e>=l?S():Y()}catch{k.show({message:"Sorry, something went wrong. Please try again!",position:"topRight",messageColor:"#fff",titleColor:"#fff",color:"#ef4040",iconUrl:"../images/our-furniture/bi_x-octagon-2.svg",maxWidth:432})}finally{Q()}}function X(e){const t=e.furnitures;window.allFurnitures=[...new Map([...window.allFurnitures,...t].map(o=>[o._id,o])).values()];const s=t.map(o=>{const{_id:r,name:i,description:c,price:H,images:j}=o;return`
  ...
  <button class="details-btn" type="button">Детальніше</button>
    ...
    `}else y.innerHTML="";p&&Array.isArray(e.color)?p.innerHTML=e.color.map((t,s)=>{const o=`color-${s}`;return`
        ...
        `).join("");ue.insertAdjacentHTML("beforeend",s),ge(),g=new N(".reviews-swiper",{modules:[z,R,W],infinite:!1,slidesPerView:3,direction:"horizontal",loop:!1,pagination:{el:".reviews-actual-slide",clickable:!0,renderBullet:function(o,r){const i=this.activeIndex||0,c=o===i?"icon-active":"";return`
